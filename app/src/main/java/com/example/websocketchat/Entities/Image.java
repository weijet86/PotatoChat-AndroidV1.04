...
public class Image {
	...
	//TODO (done)-Build a function to get Base64 from Uri link
	public String getBase64FromUri(Bitmap myBitmap) {

		//Include function to convert image URI to base64 string here.
